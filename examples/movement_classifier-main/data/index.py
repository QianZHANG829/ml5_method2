...
folder_path = "/Users/qianzhang/Desktop/ml5_method2/examples/movement_classifier-main/data/data_test9_velocity"
...
output_path = os.path.join(folder_path, "velocity_index.json")
