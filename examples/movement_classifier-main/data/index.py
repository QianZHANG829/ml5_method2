...
folder_path = "/Users/itpstudent/Desktop/ml5_method3/examples/movement_classifier-main/data/data_test10_emotion/"
...
output_path = os.path.join(folder_path, "emtion_index.json")
